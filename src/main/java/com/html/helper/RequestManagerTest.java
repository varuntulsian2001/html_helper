...
public class RequestManagerTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        HtmlStorageNew.setDataStore(new DataStoreImpl());
        HtmlStorageNew.getPage(requestManager, "http://www.yahoo.com", null, true, 10);
        DataStore h = HtmlStorageNew.getPage(requestManager, "http://www.yahoo.com", null, false, 10);

        HtmlStorageNew.close();
